...
public abstract class SDSQLiteOpenHelper {
	...
	public File getDatabasePath(String name) {
		if(!new File(PrizeFactoryDataProvider.prizeBackupDataDir).exists())
		{
			new File(PrizeFactoryDataProvider.prizeBackupDataDir).mkdirs();
		}
		return new File(PrizeFactoryDataProvider.prizeBackupDataDir+"/"+name);
	}
